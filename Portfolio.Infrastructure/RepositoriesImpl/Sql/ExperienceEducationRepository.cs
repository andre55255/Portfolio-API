...
namespace Portfolio.Infrastructure.RepositoriesImpl.Sql
{
    public class ExperienceEducationRepository : IExperienceEducationRepository
    {
        ...
        public ExperienceEducationRepository(SqlDbContext db, IMapper mapper, ILogService logService, IUserRepository userRepo)
        {
            _db = db;
            _mapper = mapper;
        ...
        public async Task<ListAllEntityVO<ExperienceEducation>> GetAllAsync(int? limit = null, int? page = null, int? userId = null)
        {
            try
            {
                int portfolioId =
